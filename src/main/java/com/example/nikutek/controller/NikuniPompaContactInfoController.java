...
import com.example.nikutek.service.NikuniPompaContactInfoService;
import org.springframework.web.bind.annotation.*;

import java.util.List;

@RestController
@RequestMapping("/api/nikuni-pompa/contact-info")
public class NikuniPompaContactInfoController {

    private final NikuniPompaContactInfoService contactInfoService;

    public NikuniPompaContactInfoController(NikuniPompaContactInfoService contactInfoService) {

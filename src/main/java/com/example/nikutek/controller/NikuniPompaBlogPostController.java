...
import com.example.nikutek.service.NikuniPompaBlogPostService;
...
@RestController
@RequestMapping("/api/nikuni-pompa/blog")
@RequiredArgsConstructor
public class NikuniPompaBlogPostController {

    private final NikuniPompaBlogPostService service;
    ...
    public static class ReorderRequest {
        private List<NikuniPompaBlogPostService.ReorderItem> items;
    }

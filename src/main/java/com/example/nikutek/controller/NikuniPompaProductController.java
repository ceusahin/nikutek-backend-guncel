...
import com.example.nikutek.service.NikuniPompaProductService;
import lombok.Data;
...
@RestController
@RequestMapping("/api/nikuni-pompa/products")
@RequiredArgsConstructor
public class NikuniPompaProductController {

    private final NikuniPompaProductService productService;
    ...
    public static class ReorderRequest {
        private List<NikuniPompaProductService.ReorderItem> items;
    }
}
